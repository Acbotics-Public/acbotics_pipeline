...
class In_Socket_UDP_Constant_Rate_Process(In_Socket_UDP_Process):
    """
    ...
    def __init__(
        self, ip_addr, port, multicast=False, multicast_interface=None, as_process=True
    ):
        """
        Creates block.
