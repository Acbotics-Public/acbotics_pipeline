...
class PR_Merge(PR_Threaded_Process):
    ...
    def __init__(self, num_inputs):
        ...
        self.current_data_frame = np.zeros((data_width.num_signals))
        self.current_indices = [0] * num_inputs
        self.next_data_frame = np.array([[] * num_inputs])
        self.next_indices = [0] * num_inputs
        super().__init__()

    def handle_data(self, dc, channel):
